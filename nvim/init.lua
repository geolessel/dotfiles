...
vim.pack.add {
  ...
  { src = 'https://github.com/nvim-mini/mini.pick' },                                                -- mini picker for file finding, etc
  { src = 'https://github.com/nvim-mini/mini.extra' },                                               -- extra utils (mostly for more pick pickers)
  { src = 'https://github.com/nvim-mini/mini.icons' },                                               -- icons for mini picker
  { src = 'https://github.com/nvim-mini/mini.pairs' },                                               -- auto-close paired openers
  { src = 'https://github.com/nvim-mini/mini.surround' },
  { src = 'https://github.com/nvim-mini/mini.clue' },                                                -- key hints like which-key
  { src = 'https://github.com/nvim-mini/mini.indentscope' },                                         -- animated indentation lines
...
vim.keymap.set("n", "<C-p>", smart_file_picker, { desc = "Open file picker" })
