...
(defun pragmata-mode--setup-compose-predicate ()
...
(defun pragmata-mode--setup-or-teardown ()
  (cond
   (pragmata-mode
...
(define-minor-mode pragmata-mode
  "Display PragmataPro font ligatures."
  :lighter " pragmata"
  :after-hook (pragmata-mode--setup-or-teardown))

(provide 'pragmata-mode)
