...
#+BEGIN_SRC emacs-lisp
(load-theme 'catppuccin-theme t) ; t treats it as safe
#+END_SRC
...
(setq modus-themes-bold-constructs t ; defualt nil
      ...
      '((1 . (overline background variable-pitch 1.3))
        ...
        (t . (semibold))))
#+end_src
*** Custom Catppuccin theme switcher
The ~catppuccin~ theme comes with 4 "flavors" but there is no easy way
to switch between them. I want one! So I'll make one.

#+begin_src emacs-lisp
(defun geo/catppuccin-switch-theme ()
  "Choose a catppuccin theme to load."
  (interactive)
  (let* ((options '(frappe latte macchiato mocha))
         (prompt "Choose a theme: ")
         (theme (completing-read prompt options)))
    (setq catppuccin-flavor (make-symbol theme))
    (catppuccin-reload)
    (message "Catppuccin flavor now %s" theme)))
#+end_src
...
(geo/cycle-display-display-time-mode -1)
#+end_src
