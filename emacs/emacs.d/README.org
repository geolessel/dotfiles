...
When I'm working on a file or looking something up, it is sometimes
helpful to open the file in Github in the browser. That makes it
easily linkable.

#+begin_src emacs-lisp
(defun geo/open-in-github ()
...
#+begin_src emacs-lisp
  (pretty-hydra-define geo/hydra-github-menu (:quit-key "q")
    ("Github"
     (("o" geo/open-in-github "Open file on Github")
      )
     ))
#+end_src
